...
public class temperature extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View cv_fromUnit = findViewById(R.id.fromUnit);
        View cv_toUnit = findViewById(R.id.toUnit);
        View cv_convert = findViewById(R.id.cv_convert);
        ...
        cv_toUnit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final AlertDialog.Builder builder = new AlertDialog.Builder(temperature.this);
